...
const molecules = {
    ...
    '2-metilbutan-1-ol': {
        ...
        atoms: [
            { element: 'O', x: -2.05, y: 0, z: 0 },
            { element: 'C', x: -0.91, y: 0, z: 0 },
            { element: 'C', x: 0.36, y: 0, z: 0 },
            { element: 'C', x: 1.63, y: 0, z: 0 },
            { element: 'C', x: 2.90, y: 0, z: 0 },
            { element: 'C', x: 0.36, y: 1.52, z: 0 },
            { element: 'H', x: -2.65, y: 0, z: 0 },
            { element: 'H', x: -0.91, y: 0.89, z: 0.51 },
            { element: 'H', x: -0.91, y: -0.89, z: 0.51 },
            { element: 'H', x: 0.36, y: -0.51, z: -1.03 },
            { element: 'H', x: 1.63, y: 0.89, z: -0.51 },
            { element: 'H', x: 1.63, y: -0.89, z: 0.51 },
            { element: 'H', x: 3.30, y: 0.89, z: 0.51 },
            { element: 'H', x: 3.30, y: -0.89, z: 0.51 },
            { element: 'H', x: 3.30, y: 0, z: -1.03 },
            { element: 'H', x: 1.23, y: 1.91, z: 0.51 },
            { element: 'H', x: -0.51, y: 1.91, z: 0.51 },
            { element: 'H', x: 0.36, y: 1.91, z: -1.03 }
        ],
        bonds: [[0,1], [1,2], [2,3], [3,4], [2,5], [0,6], [1,7], [1,8], [2,9], [3,10], [3,11], [4,12], [4,13], [4,14], [5,15], [5,16], [5,17]]
    },
    ...
    '2-metilpentan-1-ol': {
        ...
        atoms: [
            { element: 'O', x: -2.68, y: 0, z: 0 },
            { element: 'C', x: -1.54, y: 0, z: 0 },
            { element: 'C', x: -0.27, y: 0, z: 0 },
            { element: 'C', x: 1.0, y: 0, z: 0 },
            { element: 'C', x: 2.27, y: 0, z: 0 },
            { element: 'C', x: 3.54, y: 0, z: 0 },
            { element: 'C', x: -0.27, y: 1.52, z: 0 },
            { element: 'H', x: -3.28, y: 0, z: 0 },
            { element: 'H', x: -1.54, y: 0.89, z: 0.51 },
            { element: 'H', x: -1.54, y: -0.89, z: 0.51 },
            { element: 'H', x: -0.27, y: -0.51, z: -1.03 },
            { element: 'H', x: 1.0, y: 0.89, z: -0.51 },
            { element: 'H', x: 1.0, y: -0.89, z: 0.51 },
            { element: 'H', x: 2.27, y: 0.89, z: 0.51 },
            { element: 'H', x: 2.27, y: -0.89, z: -0.51 },
            { element: 'H', x: 3.94, y: 0.89, z: 0.51 },
            { element: 'H', x: 3.94, y: -0.89, z: 0.51 },
            { element: 'H', x: 3.94, y: 0, z: -1.03 },
            { element: 'H', x: 0.60, y: 1.91, z: 0.51 },
            { element: 'H', x: -1.14, y: 1.91, z: 0.51 },
            { element: 'H', x: -0.27, y: 1.91, z: -1.03 }
        ],
        bonds: [[0,1], [1,2], [2,3], [3,4], [4,5], [2,6], [0,7], [1,8], [1,9], [2,10], [3,11], [3,12], [4,13], [4,14], [5,15], [5,16], [5,17], [6,18], [6,19], [6,20]]
    },
    '3-metilbutan-2-ol': {
    ...
    'butan-2-ona': {
        ...
        bonds: [[0,1], [1,2], [2,3,'double'], [2,4], [0,5], [0,6], [0,7], [1,8], [1,9], [4,10], [4,11], [4,12]]
    },
    'pentan-2-ona': {
    ...
    'pentan-3-ona': {
        ...
        bonds: [[0,1], [1,2], [2,5,'double'], [2,3], [3,4], [0,6], [0,7], [0,8], [1,9], [1,10], [3,11], [3,12], [4,13], [4,14], [4,15]]
    },
    'hexan-2-ona': {
        ...
        bonds: [[0,1], [1,2], [2,3], [3,4], [4,5,'double'], [4,6], [0,7], [0,8], [0,9], [1,10], [1,11], [2,12], [2,13], [3,14], [3,15], [6,16], [6,17], [6,18]]
    },
    'hexan-3-ona': {
        ...
        bonds: [[0,1], [1,2], [2,3], [3,4,'double'], [3,5], [5,6], [0,7], [0,8], [0,9], [1,10], [1,11], [2,12], [2,13], [5,14], [5,15], [6,16], [6,17], [6,18]]
    },
    aceticacid: {
        name: 'Acid Acetic',
        formula: 'CH₃COOH',
